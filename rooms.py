...
class Room():
  def __init__(self, north, east, south, west, room_name, room_desc, object_1, object_1_desc,
  ...
  def setConnectedRooms(self,room):
    self.connectedRooms.append(room.room_name)
...
def main():
  room1 = Room(True, False, False, True, 'Living Room', 'A generic living room', 'couch', 'This is just a couch. Get over it.',
    'lamp', 'I love lamp', 'TV', 'Just playing some static', 'May all trouble begone with OxiClean.')
  ...
  room2 = Room(False, True, True, True, 'Dining Room', 'There is a table and a cabinet. The floor is covered by a thick carpet.',
    'table', 'A massive oak table.', 'cabinet', 'Contains cutlery, utensils, and plates.', 'carpet',
    'An abnormally thick carpet. There might be something under it.', 'Everything is a lie. Except the cake.')
